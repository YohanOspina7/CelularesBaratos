      ...
      <div className="flex flex-col gap-16 mt-8 h-fit md:flex-row">
        ...
        <div className="flex-1 space-y-5">
          ...
          {product.features.map((feature) => (
            ...
            <li key={feature} className="flex items-center gap-2 text-sm font-medium tracking-tight">
...

          {
            isOutOfStock ? (
              <button 
              className='bg-[#f3f3f3] uppercase font-semibold tracking-widest
               text-xs py-4 rounded-full transition-all duration-300 hover:bg-[#e2e2e2] w-full'
              disabled
              >
                Agotado
            ...
            <div className="flex pt-2">
              ...
              <Link to="#" className="flex flex-col items-center justify-center flex-1 gap-1" >
